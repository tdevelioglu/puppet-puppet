...
#
# This module manages configuration of puppet environments
#
# Parameters: none
#
# Actions:
...
#
define puppet::environment (
  $agent_catalog_run_lockfile       = false,
  $agent_disabled_lockfile          = false,
  $atboot                           = false,
  ...
  $manifest                         = "/etc/puppet/environments/${name}/manifests/site.pp",
  $manifestdir                      = false,
  $masterhttplog                    = false,
  $masterlog                        = false,
  $masterport                       = false,
  ...
  $modulepath                       = "/etc/puppet/environments/${name}/modules",
  ...
  concat::fragment { 'puppet.conf_environment':
      target  => '/etc/puppet/puppet.conf',
      content => template('puppet/etc/puppet/puppet.conf/environment.erb'),
      order   => 040,
  }
}
